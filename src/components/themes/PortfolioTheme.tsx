...
export default function PortfolioTheme({
  ...
  return (
    ...
    >
      ...
      {/* Hero Section */}
      <main className="relative min-h-screen flex flex-col justify-between pt-24 pb-12">
        {/* Name Block - Center */}
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
              <div className="w-[65px] h-[110px] sm:w-[90px] sm:h-[152px] md:w-[110px] md:h-[185px] lg:w-[129px] lg:h-[218px] rounded-full overflow-hidden shadow-2xl transition-transform duration-300 hover:scale-110 cursor-pointer">
                {profile.avatar ? (
                  ...
                  <div className="w-full h-full bg-linear-to-br from-blue-400 to-purple-600 flex items-center justify-center text-white text-4xl font-bold">
        ...
        {/* Bio - Always BELOW name, never overlapping */}
        <div className="w-full max-w-xl px-6 flex justify-center mb-4">
          <BlurText
      ...
      <section className="flex items-center justify-center py-12 px-4">
        <div className="w-full max-w-md mx-auto">
          <div className="flex flex-col gap-4 *:odd:rotate-3 *:even:-rotate-2 *:odd:scale-95 *:even:scale-105">
            {links.map((link) => (
              <LinkButton
                key={String(link._id)}
                link={link}
          ...
          <p className="text-center text-xs text-neutral-500 mt-12">
            ...
            <Link
              href="/"
              className="font-semibold text-[#C3E41D] hover:underline"
            >
              Tottho
            </Link>
          </p>
