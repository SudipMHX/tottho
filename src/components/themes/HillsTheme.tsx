...
/* ── Main theme ── */
export default function HillsTheme({ profile, links, username }: ThemeProps) {
  const fadeUp = {
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          >
            {profile.avatar ? (
              ...
              <div
                className="w-24 h-24 rounded-full flex items-center justify-center text-white text-3xl font-bold shadow-[0_4px_24px_rgba(0,0,0,0.5)] ring-2 ring-gray-600"
          ...
          {profile.bio && (
            ...
            >
              <p className="text-gray-300 text-sm leading-relaxed max-w-xs mx-auto drop-shadow-sm">
                {profile.bio}
              </p>
            </motion.div>
          )}
